...
import com.masseyhacks.sjam.cheqout.cart.CartItemFragment.OnListFragmentInteractionListener;
import com.masseyhacks.sjam.cheqout.cart.dummy.DummyContent;
import com.masseyhacks.sjam.cheqout.cart.dummy.DummyContent.DummyItem;
...
public class MyCartItemRecyclerViewAdapter extends RecyclerView.Adapter<MyCartItemRecyclerViewAdapter.ViewHolder> {
    ...
    public MyCartItemRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
